...
--
-- Host: 127.0.0.1
-- Generation Time: Paź 04, 2024 at 02:52 PM
...
(1, 1, '1516454981', 'Firmex', 'ul. marginowa 32/3b', '56-981', 'Wrocław', 'Finlandia'),
(2, 8, '0000000000', 'uvhyhvy', 'vvvvhyv 8', '11-111', 'ihouuobuu', 'Austria');
...
CREATE TABLE `dane_konta` (
  ...
  `nr_domu` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `dane_konta` (`id`, `id_loginu`, `imie`, `nazwisko`, `ulica`, `nr_domu`, `nr_tel`, `miasto`, `kod_pocztowy`, `kraj`, `dostep`) VALUES
(1, 1, 'Krzysiek', 'Gierek', 'Poważna', '3/8d', '573842123', 'Bydgoszcz', '98-456', 'Finlandia', 1),
(7, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(8, 9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
CREATE TABLE `firmy_kurierskie` (
  ...
  `cena` float NOT NULL,
  `rodzaj` varchar(10) CHARACTER SET utf8 COLLATE utf8_polish_ci NOT NULL,
...
INSERT INTO `firmy_kurierskie` (`id`, `nazwa_firmy`, `cena`, `rodzaj`, `sredni_czas_wysylki`) VALUES
(1, 'DHL', 13.99, 'kurier', '1-3'),
(2, 'Poczta Polska', 10.99, 'kurier', '2-4'),
(3, 'Inpost', 9.99, 'paczkomat', '1-3');
...
(1, 'admin1@g.pl', '$argon2i$v=19$m=65536,t=4,p=1$YjFBeFE1SkJaa1pScDMxNQ$2ef4mk9Xz32gOvjNEAUMHKYWvZKcrKfGfVBSmIydQNE', '2023-05-15 17:29:12', '2024-10-04 07:39:16', 'fef15f5bfbc48e99a8ab', '2023-06-06 17:21:09'),
(8, 'user@g.pl', '$argon2i$v=19$m=65536,t=4,p=1$Vi9zTmVSY0ZBVDVXYXdsVA$j51Q0obtsHtaSUeQvCKnfH8ICyoJE/3fk8RzPCpvvWY', '2024-09-19 14:54:18', '2024-09-23 07:25:52', NULL, NULL),
(9, 'krzysiu-krzys8@wp.pl', '$argon2i$v=19$m=65536,t=4,p=1$WGJ1OE9FbnQ1d053Nk5HNg$7TvVDlNIQ0FqXjLtaBD+Rt/qj1yy5dFBn6gh4kkOEI8', '2024-09-25 12:29:12', '2024-09-27 13:07:22', 'beefd9764f6b8be478b7', '2024-09-27 13:06:40');
...
(1, 'Product1', 3213.00, 24, '5', 'Plecak Nike Sportswear RPM jest stworzony do przechowywania wszystkiego, czego tylko potrzebujesz. Plecak jest idealny na wypady dzięki wyściełanemu tyłowi dla wygody i uniwersalnemu systemowi pasków.', '2024-09-09-10-41-05-0.jpg', '757012d'),
(2, 'Product2', 300.99, 23, '4', 'LPP, właściciel marki House, jest partnerem inicjatywy Cotton made in Africa (CmiA), uznanego na całym świecie standardu zrównoważonej bawełny uprawianej przez drobnych, afrykańskich rolników. Pozyskujemy bawełnę zweryfikowaną przez CmiA, pomagając w ten sposób farmerom uzyskać dostęp do zrównoważonych metod produkcji. Bawełna zweryfikowana przez CmiA, której używamy w naszym łańcuchu dostaw, ma znacznie mniejszy wpływ na środowisko niż konwencjonalna bawełna. Inicjatywa wspiera społeczności wiejskie w Afryce.', '2024-06-03-23-38-39-0.jpg', '966862i'),
(3, 'Product3', 154.99, 5, '7', 'Plecak Vans Old Skool Check ma dużą komorę główną, łatwo dostępną kieszeń z przegródkami zapinaną na suwak z przodu oraz kieszeń na butelkę z wodą. Wyściełane paski naramienne o prostym kroju zapewniają dodatkową wygodę. Całości dopełnia logo Vans z przodu oraz nadruk w kratę na całej powierzchni. Wymiary: 41,9 cm dł. x 32,4 cm szer. x 12,1 cm głęb. Pojemność: 22 litry.', '2024-06-03-23-45-08-0.jpg', '98554t'),
(4, 'Product4', 180.00, 13, '7', 'Czarny męski plecak o prostej, klasycznej formie. Idealny na co dzień: do szkoły, na uczelnię, do pracy.\r\n\r\ngłówna komora oraz zewnętrzna kieszeń zapinane na suwaki\r\ndługie szelki z możliwością regulacji\r\nwewnętrzna kieszeń na laptopa\r\nniewielka naszywka z przodu', '2024-06-03-23-40-49-0.png', '996025d'),
(5, 'Product5', 70.00, 25, '2', 'KOSZULKA OVERSIZE STRONG POINT   \r\n\r\nMamy dla Was koszulkę idealną. Luźny, najmodniejszy krój, perfekcyjna długość, przewiewna bawełna, genialna dzianina. Będziecie zachwycone!  \r\n\r\nDelikatne, wyszywane logo w kolorze produktu sprawia, że koszulkę możecie nosić do niemal każdej stylizacji', '2024-06-03-23-43-43-0.jpg', '327894f'),
(6, 'Product6', 890.00, 14, '10', 'cfy', '2024-06-03-23-44-26-0.jpg', '513819u'),
(7, 'Product7', 234.00, 22, '11', 'Ładna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreomŁadna lorem lreom', '2024-06-03-23-40-33-0.png', '272335o'),
(8, 'Product8', 32.00, 10, '3', '        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facilis tempora quibusdam quis placeat. Eos, quam dicta suscipit dolorem officia neque accusamus blanditiis eius sunt recusandae magnam similique, nam delectus?', '2024-10-04-07-48-30-0.jpg', '43476s'),
(9, 'Product9', 32.00, 10, '3', '        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facilis tempora quibusdam quis placeat. Eos, quam dicta suscipit dolorem officia neque accusamus blanditiis eius sunt recusandae magnam similique, nam delectus?', '2024-10-04-12-40-47-0.VAxOKne-u_DUskCOQCy4Yr0iRrvTRtdszx5X6fipDeM', '86521a');
...
--
ALTER TABLE `rozmiary_produktow`
  ADD CONSTRAINT `id_rozmiary_produkty` FOREIGN KEY (`id_produktu`) REFERENCES `produkty` (`id`);

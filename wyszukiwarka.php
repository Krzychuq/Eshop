...
$slowo = "%". $_REQUEST["q"] . "%";
//pytanie o produkty
$szukaj1 = $conn->prepare('SELECT nazwa, cena, zdjecie, link FROM produkty WHERE nazwa like ? LIMIT 10');
...
if($szukaj1-> rowCount() > 0) {
  ...
  while($wynik = $szukaj1->fetch()){
    ...
    echo "<div class='wyszukiwanie_produkt'><a style='text-decoration:none; color: #171717;' href=".$wynik['link'].">
